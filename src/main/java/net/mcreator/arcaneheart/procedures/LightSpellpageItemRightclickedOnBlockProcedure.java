...
public class LightSpellpageItemRightclickedOnBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, ItemStack itemstack) {
		ArcaneHeartMod.queueServerWork(4, () -> {
			itemstack.shrink(1);
			world.setBlock(BlockPos.containing(x, y + 1, z), ArcaneHeartModBlocks.MAGELIGHT.get().defaultBlockState(), 3);
		});
	}
}
