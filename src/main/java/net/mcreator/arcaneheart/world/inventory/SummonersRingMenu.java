...
package net.mcreator.arcaneheart.world.inventory;
...
public class SummonersRingMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public SummonersRingMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(ArcaneHeartModMenus.SUMMONERS_RING.get(), id);
